...
const DetailPage = () => {
  ...
  const formatPokemonStats = ([
    ...
    { name: "Special Attak", baseStat: statSATK.base_stat },
      ...
      >
        ...
        <section className="w-full min-h-[65%] h-full bg-gray-800 z-10 pt-14 flex flex-col items-center gap-3 px-5 pb-4">
          ...
          <div className="flex w-full items-center justify-between max-w-[400px] text-center">
            ...
            <div className="w-full ">
              <h4 className="text-[0.5rem] text-zinc-100"> ab </h4>
          ...
          <div className="text-md leading-4 font-sans text-zinc-200 max-w-[30rem] text-center">
            {pokemon.description}
          </div>
          <div className="flex my-8 flex-wrap justify-center">
            {pokemon.sprites.map((url, index) => (
              <img src={url} key={index} alt="sprites" />
            ))}
          </div>
        </section>
      </div>
